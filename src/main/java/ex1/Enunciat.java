...
/*
    ...
    3. Grava en vídeo el següent:
        ...
        TODO Click dret sobre el directori del projecte, fer click a "Add Framework Support, seleccionar Maven."
        ...
        3.2. Mostra el log de GitHub, en concret la línia on es veuen les proves executades, per a demostrar que
             ...
             TODO https://github.com/AngelCM08/MP05UF2P2/actions
             Al executar les actions per primer cop, després d'haver activat els permisos de lectura i escriptura del
             Workflow a Settings/Actions, també he habilitat el dependency graph perque em sortia un error.
        ...
        TODO 3.3. Explica en què consisteix el concepte de Continuous Integration (CI) i quina relació té amb el que
